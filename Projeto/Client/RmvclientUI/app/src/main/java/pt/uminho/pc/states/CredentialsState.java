...
public class CredentialsState implements GameState {
    ...
    public void draw(GUI context) {
        ...
        // submit
        boolean over = isMouseOver(context, 75, 200, 100, 30);
        context.fill(over ? 150 : 100);
        context.rect(75, 200, 100, 30);
        context.fill(255);
        context.text("Submit", 85, 220);
    }
    ...
    public void mousePressed(GUI context) {
        if (isMouseOver(context, 200, 60, 200, 30)) {
            ...
            boolean success = context.authenticate();
            if (success) {
